Feature: Checking User Registration  
  ...
  Scenario Outline: To check the Creating New Customer Account page with valid and invalid data  
    ...
    Examples:  
      ...
      | srikar    | suggu    | fgguwey		           | Pass@1234   | Pass@1234	     | srikarsugu45@gmail.com  | Thank you for registering with Main Website Store.   |Please enter a valid email address (Ex: johndoe@domain.com).|
